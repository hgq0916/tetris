...
public class TriangleBlock extends Block{
   ...
   */
  private void init() {
    MetaBlock[][] metaBlocks = new MetaBlock[2][3];
    int tempX = this.x;
    int tempY = this.y;
    ...
    metaBlocks[1][2] = new MetaBlock(this.mainWindow,tempX+2*MetaBlock.BLOCK_WIDTH,tempY+1*MetaBlock.BLOCK_HEIGHT,this.color);
    //设置中心
    center[0] = 1;
    center[1] = 1;

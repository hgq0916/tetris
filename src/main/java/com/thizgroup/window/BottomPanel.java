...
public class BottomPanel extends JPanel {
  ...
  public BottomPanel(MainWindow mainWindow){
    ...
    this.setBounds(40,MainWindow.TITLE_BAR_HEIGHT+335,170,100);
  }
  ...
  public void paint(Graphics src) {
    ...
    graphics2D.fillRect(0,0,170,100);
    graphics2D.setColor(Color.pink);
    graphics2D.drawString(COPYRIGHT1,5,15);
    graphics2D.drawString(COPYRIGHT2,5,30);
  }
}
